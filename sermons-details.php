                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="single-latest-post">
                                ...
                                <div class="sermons-meta-data">
                                    <p><i class="fa fa-user" aria-hidden="true"></i> Sermon From: <span>Pr. Possiano</span></p>
                            ...
                            <div class="single-latest-post">
                                ...
                                <div class="sermons-meta-data">
                                    <p><i class="fa fa-user" aria-hidden="true"></i> Sermon From: <span>Pr. Henry Musubize</span></p>
                                    <p><i class="fa fa-tag" aria-hidden="true"></i> Categories: <span>God, Pray</span></p>
                                    <p><i class="fa fa-clock-o" aria-hidden="true"></i> March 10 on <span>9:00 am - 11:00 am</span></p>
                                </div>
                            </div>
