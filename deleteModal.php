...
<div class="modal fade" id="deleteModal<?php echo $id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <h3>Are you sure your want to delete if so please press delete but if not then press cancel button <strong style="color:red;"><u><?php echo $name;?></u>?</strong></h3>
  ...
  </div><!--closing div for the modal section.-->
</div>