                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-blog-post mb-50">
                                ...
                                <div class="post-content">
                                    <a href="single-post.html" class="post-title">
                                        <h4>A daily guide to live right with God</h4>
                                    </a>
                                    <div class="post-meta d-flex">
                                        <a href="#"><i class="fa fa-user" aria-hidden="true"></i> Staff Reporter</a>
                                        <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i> Oct 03, 2018</a>
                                    </div>
                                    <p class="post-excerpt">Daily fellowship with God.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-blog-post mb-50">
                                ...
                                <div class="post-content">
                                    <a href="single-post.html" class="post-title">
                                        <h4>UCC churches to have Sports .</h4>
                                    </a>
                                    <div class="post-meta d-flex">
                                        <a href="#"><i class="fa fa-user" aria-hidden="true"></i> Team Leader</a>
                                        <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i> October 29, 2018</a>
                                    </div>
                                    <p class="post-excerpt">These games are intended to bring brethren together of different UCC Churches in Uganda.</p>
                                </div>
                            </div>
                        </div>
